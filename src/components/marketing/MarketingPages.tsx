    ...
    const plans = [
      {
        ...
        features: ['1 office', 'Up to 10 team members', 'Basic time tracking', 'Shift scheduling', 'Task management', '2 custom roles', 'Email support', '5GB storage']
      },
      {
        ...
        features: ['Up to 5 offices', 'Up to 50 team members', 'Advanced time tracking & wages', 'Auto-recurring shifts', 'Leave & meeting requests', 'Break logging', 'Inventory management', 'Unlimited custom roles', 'Activity logs & downloads', 'Priority support', '50GB storage']
      },
      {
        ...
        features: ['Unlimited offices', 'Unlimited team members', 'Everything in Professional', 'Advanced analytics & insights', 'Multi-office management', 'API access', '24/7 phone support', 'Unlimited storage', 'Custom branding', 'SLA guarantee']
      }
    ];
